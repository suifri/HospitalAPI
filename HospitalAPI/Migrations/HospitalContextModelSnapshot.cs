...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HospitalAPI.Models.LabScreening", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("LabScreening", (string)null);
                });
            ...
            modelBuilder.Entity("NursePatient", b =>
                {
                    ...
                    b.ToTable("NursePatient", (string)null);
                });
            ...
            modelBuilder.Entity("HospitalAPI.Models.Nurse", b =>
                {
                    b.HasOne("HospitalAPI.Models.Staff", "Staff_")
                        .WithOne("Nurse_")
                        .HasForeignKey("HospitalAPI.Models.Nurse", "StaffId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("NursePatient", b =>
                {
                    b.HasOne("HospitalAPI.Models.Nurse", null)
                        .WithMany()
