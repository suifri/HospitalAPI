...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HospitalAPI.Models.HospitalUser", b =>
                {
            ...
            modelBuilder.Entity("HospitalAPI.Models.Schedule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HospitalAPI.Models.Schedule", b =>
                {
                    b.HasOne("HospitalAPI.Models.Doctor", "Doctor_")
                        .WithOne("Schedule_")
                        .HasForeignKey("HospitalAPI.Models.Schedule", "DoctorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HospitalAPI.Models.HospitalUser", null)
                        .WithMany()
